...
2. **A large-scale dataset of technical records from TIB’s open-access collection, annotated with GND subjects and domains, available in both English and German.**
